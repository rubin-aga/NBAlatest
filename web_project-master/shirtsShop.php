...
if (isset($_POST["add"])) {
    ...
    echo '<script>window.location="shirtsShop.php"</script>';
}
...
<body>
<div class="header">
    <h2 class="logo zoomIn" ; style="text-transform: none;">NBAlatest - Shirts</h2>
...
<?php
$query = "SELECT * FROM shirts ORDER BY id ASC ";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo '<td>
            <div class="card">
            <img src="img/shirts/' . $row['name'] . '.png" alt="ks">
            <div class = "container">
                <h2>' . $row['actual_name'] . '  $' . $row['price'] . '</h2>
                <form method="post" action="shirtsShop.php?action=add&id=" ' . $row["id"] . ' >
        ...
        if (!empty($_SESSION["cart"])) {
            ...
            foreach ($_SESSION["cart"] as $key => $value) {
                ...
                <tr>
                    ...
                    <td><a href="shirtsShop.php?action=delete&hidden_id=<?php echo $value["hidden_id"]; ?>"><span
